# Start GeckoDriver and make it non-blocking with ampersand
./bin/geckodriver &

# Keep track of the GeckoDrivers Process ID
TASK_PID=$!

# Wait for 10 seconds to give the GeckoDriver a chance to fail if there is an
# issue.
sleep 10
