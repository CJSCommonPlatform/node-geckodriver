...
let tempInstallPath = path.resolve(tmpdir, 'geckodriver-test');
...
for (let version of versions) {
    ...
    let tempInstallPathForVersion = path.resolve(tmpdir, 'geckodriver-test', version);
    ...
    let executable = path.resolve(tempInstallPathForVersion, 'node_modules', 'geckodriver', 'lib', 'geckodriver', `geckodriver${os.platform() === 'win32' ? '.exe' : ''}`);
